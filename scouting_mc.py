...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
     'file:/eos/user/a/adlintul/miniaod.root'
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:scoutingnano_mc.root'),
...
process.load("PhysicsTools.NanoAOD.nanogenDQM_cff")
process.DQMOfflineNanoGen = cms.Sequence(process.nanogenDQM)
process.nanoAOD_step = cms.Path(process.nanogenSequence*process.DQMOfflineNanoGen)
...
from Run3ScoutingAnalysisTools.Analysis.Run3Scouting_cff import run3Scouting_customiseMC

#call to customisation function customise imported from Run3ScoutingAnalysisTools.Analysis.Run3Scouting_cff
process = run3Scouting_customiseMC(process)
