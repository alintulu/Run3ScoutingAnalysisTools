...
config.General.workArea = 'crab_projects_QCD_Pt15to7000'
config.General.requestName = 'QCD_Pt15to7000_TuneCP5_14TeV-pythia8-v2'
config.section_('JobType')
config.JobType.numCores = 1
config.JobType.sendExternalFolder = True
config.JobType.pyCfgParams = ['inputDataset=/QCD_Pt15to7000_TuneCP5_14TeV-pythia8/Run3Winter21DRMiniAOD-FlatPU0to80_Scouting_Patatrack_castor_112X_mcRun3_2021_realistic_v16-v2/MINIAODSIM', 'outputFileMini=mini.root']
