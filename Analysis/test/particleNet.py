...
process.ak8ScoutingJetParticleNet = cms.EDAnalyzer("ScoutingPartcileNetNtupleProducer",
...
process.p = cms.Path(process.nanoSequenceScouting*process.ak8ScoutingJetParticleNet)
