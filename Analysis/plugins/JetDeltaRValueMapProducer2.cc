/* \class JetDeltaRValueMapProducer2
 *
...
class JetDeltaRValueMapProducer2 : public edm::stream::EDProducer<> {
public:
  typedef TN value_type;
  typedef edm::ValueMap<value_type> JetValueMap;
  typedef std::vector<value_type> ValueVector;

  JetDeltaRValueMapProducer2(edm::ParameterSet const& params)
  ...
  ~JetDeltaRValueMapProducer2() override {}
...
typedef JetDeltaRValueMapProducer2<reco::Jet> RecoJetDeltaRValueMapProducer2;
typedef JetDeltaRValueMapProducer2<reco::Jet, pat::Jet> RecoJetToPatJetDeltaRValueMapProducer2;
typedef JetDeltaRValueMapProducer2<pat::Jet> PatJetDeltaRValueMapProducer2;
typedef JetDeltaRValueMapProducer2<reco::Jet, reco::GenJet, int> RecoJetToGenJetDeltaRValueMapProducer2;

DEFINE_FWK_MODULE(RecoJetDeltaRValueMapProducer2);
DEFINE_FWK_MODULE(RecoJetToPatJetDeltaRValueMapProducer2);
DEFINE_FWK_MODULE(PatJetDeltaRValueMapProducer2);
DEFINE_FWK_MODULE(RecoJetToGenJetDeltaRValueMapProducer2);
